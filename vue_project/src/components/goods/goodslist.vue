            ...
            <ul class="mui-table-view mui-grid-view">
                <li v-for="(item,index) in list" :key="index" class="mui-table-view-cell mui-media mui-col-xs-6">
                    <router-link v-bind="{to:'/goods/goodsinfo/'+item.id}">
                        ...
                        <div class="mui-media-body">{{item.title}}</div><div class="desc">
                            <p>
...
click: 0,
img_url: "http://vue.studyit.io/upload/201504/20/thumb_201504200046589514.jpg",
sell_price: 2195,
market_price: 2499,
stock_quantity: 60
},
...
click: 0,
img_url: "http://vue.studyit.io/upload/201504/20/thumb_201504200059017695.jpg",
sell_price: 5780,
market_price: 6388,
stock_quantity: 200
}*/
    ...
    methods:{
        getimgs(){
            var url = "api/getgoods?pageindex=1";
